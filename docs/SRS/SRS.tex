...
\begin{description}
    \item[Bandwidth] The Application must not occupy more than 20MB/s download speed[1] and 5 MB/s upload speed[2], as these two numbers are the most common home internet speeds for Canadian families.
...
\begin{itemize}
  \item The application will be designed to comply with all applicable laws and regulations[4][5][6]. User personal information will only be collected or used with explicit consent.
