...
\begin{itemize}
    \color{red}
        \item[FR17] The system shall provide center of mass annotation.  \label{FR17}
        \begin{itemize}
            \item Rationale: To identify the instructor's supporting foot and increase Tai Chi learning experience.
            \item Priority: Critical
        \end{itemize}
    \end{itemize}
