...
\begin{description}
\item[SRS]
  \href{https://github.com/InfiniView-AI/MotionMingle/blob/main/docs/SRS/SRS.pdf}{/docs/SRS/SRS.pdf}
...
\item[Development Plan]
  \href{https://github.com/InfiniView-AI/MotionMingle/blob/main/docs/DevelopmentPlan/DevelopmentPlan.pdf}{/docs/DevelopmentPlan/DevelopmentPlan.pdf}
...
\item[Hazard Analysis]
  \href{https://github.com/InfiniView-AI/MotionMingle/blob/main/docs/HazardAnalysis/HazardAnalysis.pdf}{/docs/HazardAnalysis/HazardAnalysis.pdf}
...
after the observation study. Participants will be asked to rate their experience
in using the application, in the scale of 1 (unsatisfied) to 10 (satisfied). The
targeted satisfactory factor is set to 85\%.
...
\item \label{FRT11}
  ...
  \item[How Test Will Be Performed] Structural tests will be used to evaluate the
