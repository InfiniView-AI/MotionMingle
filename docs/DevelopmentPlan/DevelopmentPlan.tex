...
\sout{We are committed to a typical git workflow in modern production environments.
...
subtask. If a member encounters unexpected errors or behaviours outside the scope
